            ...
            <AnimatePresence mode="wait">
              ...
              {view === "sent" && (
                ...
                >
                  ...
                  <p className="mb-12 max-w-sm whitespace-pre-line text-center text-[14px] leading-relaxed text-text-secondary">
              ...
              {view === "error" && (
                ...
                >
                  ...
                  <p className="mb-12 max-w-md whitespace-pre-line text-center text-[14px] leading-relaxed text-text-secondary">
